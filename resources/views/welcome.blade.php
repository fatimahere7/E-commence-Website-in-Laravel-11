                ...
                <div class="carousel-item active">
                  <div class="container-fluid">
                    <div class="row">
                      ...
                      <div class="col-md-5 ">
                        <div class="img-box">
                          <img style="width:600px" src="{{ asset('assets/site/images/eCommerce-store.jpg') }}" alt="" />
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card">
                    <div class="img-box">  
                        @if($product->images->isNotEmpty())
                            <img src="{{ asset('images/products/' . $product->images->first()->image_path) }}" alt="Product Image" class="card-img-top custom-card-img">
                        @else
                            <img src="{{ asset('images/no-image-available.png') }}" alt="No Image" class="card-img-top custom-card-img">
                        @endif
                    </div>
                    <div class="card-body">
                        ...
                        <form action="{{ route('addCart', $product->id) }}" method="GET">
                          ...
                          <div class="quantity">
                              <div class="pro-qty">
                                <input type="hidden" name="quantity" min="1" max="{{ $product->quantity }}" value="1" />
                              </div>
                              <br>
                          </div>
  ...
  <div class="box">
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-6">
          <div class="img-box">
            <img src="{{ asset('assets/site/images/saving-img.png') }}" alt="">
          </div>
        </div>
        <div class="col-lg-6">
          <div class="detail-box">
